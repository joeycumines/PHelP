...
namespace JoeyCumines\Phelp\Utility\Test;

/**
 * Trait AssertExactEquals
 *
 * @package JoeyCumines\Phelp\Utility\Test
 *
...
trait AssertExactEquals
{
     ...
     */
    private function assertExactEquals($expected, $actual, $message = '', $lineLength = 80)
    {
